...
public class ConexionDB {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/integrador_cac?useSSL=false&requireuseSSL=false";
    private static final String USER = "root";
    private static final String PASSWORD = "40John891";
